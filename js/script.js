!function () {
    ...
    (t => {
        const {
            ...
            top: u,
            doNotTrack: d
        } = t, {currentScript: l, referrer: f} = s;
        if (!l) return;
        const {hostname: h, href: m, origin: p} = o, y = m.startsWith("data:") ? void 0 : t.localStorage, g = "data-",
            b = "true", v = l.getAttribute.bind(l), S = v(g + "website-id"), k = v(g + "host-url"),
            w = v(g + "before-send"), N = v(g + "tag") || void 0, T = "false" !== v(g + "auto-track"),
            A = v(g + "do-not-track") === b, j = v(g + "exclude-search") === b, x = v(g + "exclude-hash") === b,
            $ = v(g + "domains") || "", E = $.split(",").map((t => t.trim())),
            K = `${(k || "" || l.src.split("/").slice(0, -1).join("/")).replace(/\/$/, "")}/api/send`, L = `${e}x${a}`,
            O = /data-umami-event-([\w-_]+)/, _ = g + "umami-event", D = 300, U = () => ({
                website: S,
                screen: L,
                language: n,
                title: s.title,
                ...
                if ("function" == typeof n && (e = n(a, e)), e) try {
                    const t = await fetch(K, {
                        ...
                        headers: {"Content-Type": "application/json", ...void 0 !== R && {"x-umami-cache": R}},
                        credentials: "omit"
                    }), n = await t.json();
            ...
            P = (t, e) => ("string" == typeof t && (q = t), R = "", C({
                ...U(),
                data: "object" == typeof t ? t : e
            }, "identify"));
        t.umami || (t.umami = {track: J, identify: P});
        let R, q, z = m, F = f.startsWith(p) ? "" : f, G = !1, H = !1;
